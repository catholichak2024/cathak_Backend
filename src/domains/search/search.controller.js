...
import { searchService, postMarkService, delMarkService } from "./search.service.js";
...
export const delMarkController = async (req, res, next) => {
  console.log("북마크 삭제를 요청했습니다!");
  const userId = req.decoded.userId;
  res.send(response(status.SUCCESS, await delMarkService(userId, req.params.id)));
}